...
# its own assets/<style> folder. Both fall back to "classic" when they do not
# cover a request. See screens/menu_screens/unit_art.py for the picker.
...
DEFAULT_TRUCE_TURNS = 12
MIN_TRUCE_TURNS = 0
MAX_TRUCE_TURNS = 12
TRUCE_TURNS = DEFAULT_TRUCE_TURNS
...
CAMERA_KEYBOARD_PAN_PIXELS_PER_SECOND = 1200
...
ICON_REPAIRING = "Repairing"
ICON_UPGRADING = "Upgrading"
...
UNILATERAL_ACTIONS = [
    ...
    "FORWARD_MESSAGE",
    "RECALL_VOLUNTEERS",
    "SEND_HOME_VOLUNTEERS",
    "GUARANTEE",
    "REVOKE_GUARANTEE",
    "WITHDRAW_MILITARY_ATTACHE",
    "REVOKE_MILITARY_ATTACHE",
]
...
MESSAGE_CATEGORIES = {
    ...
    "SEND_HOME_VOLUNTEERS": "VOLUNTEERS",
    "GUARANTEE": "GUARANTEE",
    ...
    "REVOKE_MILITARY_ATTACHE": "ATTACHÉ",
...
DEFAULT_ARMY_SYMBOL_FLIPPED = False
...
# style (e.g. assets/hanskolmer). Each has a unit_art.json file for culture
# metadata and can contain baseline/tiered art filenames such as
# artillery.png and infantry_<year>.png.
...
SHUFFLE_DISABLED_TRACKS_PATH = "data/json/shuffle_disabled_tracks.json"
